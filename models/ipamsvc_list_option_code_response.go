...
func (m *IpamsvcListOptionCodeResponse) validateResults(formats strfmt.Registry) error {
...
func (m *IpamsvcListOptionCodeResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcListOptionCodeResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcListOptionCodeResponse
