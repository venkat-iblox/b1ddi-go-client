...
func (m *ConfigCreateAuthNSGResponse) validateResult(formats strfmt.Registry) error {
...
func (m *ConfigCreateAuthNSGResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigCreateAuthNSGResponse) UnmarshalBinary(b []byte) error {
	var res ConfigCreateAuthNSGResponse
