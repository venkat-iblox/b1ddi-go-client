...
func (m *ConfigReadDelegationResponse) validateResult(formats strfmt.Registry) error {
...
func (m *ConfigReadDelegationResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigReadDelegationResponse) UnmarshalBinary(b []byte) error {
	var res ConfigReadDelegationResponse
