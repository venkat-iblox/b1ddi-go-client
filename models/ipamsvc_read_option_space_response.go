...
func (m *IpamsvcReadOptionSpaceResponse) validateResult(formats strfmt.Registry) error {
...
func (m *IpamsvcReadOptionSpaceResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcReadOptionSpaceResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcReadOptionSpaceResponse
