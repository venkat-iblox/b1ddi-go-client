...
func (m *IpamsvcReadIPSpaceResponse) validateResult(formats strfmt.Registry) error {
...
func (m *IpamsvcReadIPSpaceResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcReadIPSpaceResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcReadIPSpaceResponse
