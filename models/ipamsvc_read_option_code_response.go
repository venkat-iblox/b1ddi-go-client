...
func (m *IpamsvcReadOptionCodeResponse) validateResult(formats strfmt.Registry) error {
...
func (m *IpamsvcReadOptionCodeResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcReadOptionCodeResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcReadOptionCodeResponse
