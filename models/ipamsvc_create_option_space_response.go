...
func (m *IpamsvcCreateOptionSpaceResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IpamsvcCreateOptionSpaceResponse) validateResult(formats strfmt.Registry) error {
...
func (m *IpamsvcCreateOptionSpaceResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcCreateOptionSpaceResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcCreateOptionSpaceResponse
