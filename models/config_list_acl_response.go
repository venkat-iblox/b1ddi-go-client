...
func (m *ConfigListACLResponse) validateResults(formats strfmt.Registry) error {
...
func (m *ConfigListACLResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
