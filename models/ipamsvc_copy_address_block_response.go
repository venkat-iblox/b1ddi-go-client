...
// IpamsvcCopyAddressBlockResponse CopyAddressBlockResponse
//
...
func (m *IpamsvcCopyAddressBlockResponse) validateResult(formats strfmt.Registry) error {
...
// ContextValidate validate this ipamsvc copy address block response based on the context it is used
...
func (m *IpamsvcCopyAddressBlockResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
