...
func (m *IpamsvcReadRangeResponse) validateResult(formats strfmt.Registry) error {
...
func (m *IpamsvcReadRangeResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcReadRangeResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcReadRangeResponse
