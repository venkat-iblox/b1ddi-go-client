...
func (m *IpamsvcReadOptionGroupResponse) validateResult(formats strfmt.Registry) error {
...
func (m *IpamsvcReadOptionGroupResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcReadOptionGroupResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcReadOptionGroupResponse
