...
func (m *IpamsvcReadGlobalResponse) validateResult(formats strfmt.Registry) error {
...
func (m *IpamsvcReadGlobalResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcReadGlobalResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcReadGlobalResponse
