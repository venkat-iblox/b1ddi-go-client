...
func (m *IpamsvcUpdateHAGroupResponse) validateResult(formats strfmt.Registry) error {
...
func (m *IpamsvcUpdateHAGroupResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcUpdateHAGroupResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcUpdateHAGroupResponse
