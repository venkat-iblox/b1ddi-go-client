...
func (m *IpamsvcListOptionSpaceResponse) validateResults(formats strfmt.Registry) error {
...
func (m *IpamsvcListOptionSpaceResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcListOptionSpaceResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcListOptionSpaceResponse
