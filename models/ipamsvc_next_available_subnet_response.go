...
func (m *IpamsvcNextAvailableSubnetResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IpamsvcNextAvailableSubnetResponse) validateResults(formats strfmt.Registry) error {
...
func (m *IpamsvcNextAvailableSubnetResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcNextAvailableSubnetResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcNextAvailableSubnetResponse
