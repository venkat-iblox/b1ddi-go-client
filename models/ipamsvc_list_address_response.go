...
func (m *IpamsvcListAddressResponse) validateResults(formats strfmt.Registry) error {
...
func (m *IpamsvcListAddressResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcListAddressResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcListAddressResponse
