...
func (m *DataSOASerialIncrementResponse) validateResult(formats strfmt.Registry) error {
...
func (m *DataSOASerialIncrementResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DataSOASerialIncrementResponse) UnmarshalBinary(b []byte) error {
	var res DataSOASerialIncrementResponse
