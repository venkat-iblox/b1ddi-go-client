...
func (m *ConfigInheritedDNSSECValidationBlock) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ConfigInheritedDNSSECValidationBlock) validateValue(formats strfmt.Registry) error {
...
func (m *ConfigInheritedDNSSECValidationBlock) contextValidateDisplayName(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigInheritedDNSSECValidationBlock) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigInheritedDNSSECValidationBlock) UnmarshalBinary(b []byte) error {
	var res ConfigInheritedDNSSECValidationBlock
