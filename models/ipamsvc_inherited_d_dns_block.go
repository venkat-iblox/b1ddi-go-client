...
func (m *IpamsvcInheritedDDNSBlock) validateValue(formats strfmt.Registry) error {
...
func (m *IpamsvcInheritedDDNSBlock) contextValidateDisplayName(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcInheritedDDNSBlock) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcInheritedDDNSBlock) UnmarshalBinary(b []byte) error {
	var res IpamsvcInheritedDDNSBlock
