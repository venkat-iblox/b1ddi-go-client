...
func (m *IpamsvcReadFixedAddressResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IpamsvcReadFixedAddressResponse) validateResult(formats strfmt.Registry) error {
...
func (m *IpamsvcReadFixedAddressResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcReadFixedAddressResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcReadFixedAddressResponse
