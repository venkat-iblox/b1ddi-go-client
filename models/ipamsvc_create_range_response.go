...
func (m *IpamsvcCreateRangeResponse) validateResult(formats strfmt.Registry) error {
...
func (m *IpamsvcCreateRangeResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcCreateRangeResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcCreateRangeResponse
