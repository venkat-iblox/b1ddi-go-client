...
func (m *ConfigServer) validateSortList(formats strfmt.Registry) error {
...
func (m *ConfigServer) contextValidateSortList(ctx context.Context, formats strfmt.Registry) error {
