...
func (m *IpamsvcCreateAddressResponse) validateResult(formats strfmt.Registry) error {
...
func (m *IpamsvcCreateAddressResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcCreateAddressResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcCreateAddressResponse
