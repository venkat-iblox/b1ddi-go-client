...
func (m *ConfigListDelegationResponse) validateResults(formats strfmt.Registry) error {
...
func (m *ConfigListDelegationResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigListDelegationResponse) UnmarshalBinary(b []byte) error {
	var res ConfigListDelegationResponse
