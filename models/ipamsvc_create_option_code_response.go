...
func (m *IpamsvcCreateOptionCodeResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IpamsvcCreateOptionCodeResponse) validateResult(formats strfmt.Registry) error {
...
func (m *IpamsvcCreateOptionCodeResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcCreateOptionCodeResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcCreateOptionCodeResponse
