...
func (m *IpamsvcCreateNextAvailableABResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IpamsvcCreateNextAvailableABResponse) validateResults(formats strfmt.Registry) error {
...
func (m *IpamsvcCreateNextAvailableABResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcCreateNextAvailableABResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcCreateNextAvailableABResponse
