...
func (m *IpamsvcCreateIpamHostResponse) validateResult(formats strfmt.Registry) error {
...
func (m *IpamsvcCreateIpamHostResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcCreateIpamHostResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcCreateIpamHostResponse
