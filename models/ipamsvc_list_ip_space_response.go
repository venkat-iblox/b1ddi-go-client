...
func (m *IpamsvcListIPSpaceResponse) validateResults(formats strfmt.Registry) error {
...
func (m *IpamsvcListIPSpaceResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcListIPSpaceResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcListIPSpaceResponse
