...
func (m *IpamsvcUpdateSubnetResponse) validateResult(formats strfmt.Registry) error {
...
func (m *IpamsvcUpdateSubnetResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcUpdateSubnetResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcUpdateSubnetResponse
