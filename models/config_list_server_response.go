...
func (m *ConfigListServerResponse) validateResults(formats strfmt.Registry) error {
...
func (m *ConfigListServerResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigListServerResponse) UnmarshalBinary(b []byte) error {
	var res ConfigListServerResponse
