...
func (m *IpamsvcUpdateAddressResponse) validateResult(formats strfmt.Registry) error {
...
func (m *IpamsvcUpdateAddressResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcUpdateAddressResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcUpdateAddressResponse
