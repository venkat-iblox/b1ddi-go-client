...
func (m *IpamsvcReadHAGroupResponse) validateResult(formats strfmt.Registry) error {
...
func (m *IpamsvcReadHAGroupResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcReadHAGroupResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcReadHAGroupResponse
