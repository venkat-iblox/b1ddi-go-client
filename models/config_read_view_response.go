...
func (m *ConfigReadViewResponse) validateResult(formats strfmt.Registry) error {
...
func (m *ConfigReadViewResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigReadViewResponse) UnmarshalBinary(b []byte) error {
	var res ConfigReadViewResponse
