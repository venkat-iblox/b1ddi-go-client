...
func (m *DataReadRecordResponse) validateResult(formats strfmt.Registry) error {
...
func (m *DataReadRecordResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DataReadRecordResponse) UnmarshalBinary(b []byte) error {
	var res DataReadRecordResponse
