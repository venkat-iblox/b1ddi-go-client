...
func (m *IpamsvcReadAddressResponse) validateResult(formats strfmt.Registry) error {
...
func (m *IpamsvcReadAddressResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcReadAddressResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcReadAddressResponse
