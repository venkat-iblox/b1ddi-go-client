...
func (m *IpamsvcCreateOptionGroupResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IpamsvcCreateOptionGroupResponse) validateResult(formats strfmt.Registry) error {
...
func (m *IpamsvcCreateOptionGroupResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcCreateOptionGroupResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcCreateOptionGroupResponse
