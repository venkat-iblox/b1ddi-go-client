...
func (m *ConfigCopyForwardZoneResponse) validateResult(formats strfmt.Registry) error {
...
func (m *ConfigCopyForwardZoneResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigCopyForwardZoneResponse) UnmarshalBinary(b []byte) error {
	var res ConfigCopyForwardZoneResponse
