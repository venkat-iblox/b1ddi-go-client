...
func (m *IpamsvcUpdateIPSpaceResponse) validateResult(formats strfmt.Registry) error {
...
func (m *IpamsvcUpdateIPSpaceResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcUpdateIPSpaceResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcUpdateIPSpaceResponse
