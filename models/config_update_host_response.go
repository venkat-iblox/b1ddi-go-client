...
func (m *ConfigUpdateHostResponse) validateResult(formats strfmt.Registry) error {
...
func (m *ConfigUpdateHostResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigUpdateHostResponse) UnmarshalBinary(b []byte) error {
	var res ConfigUpdateHostResponse
