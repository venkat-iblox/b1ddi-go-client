...
func (m *IpamsvcInheritedAsmEnableBlock) validateValue(formats strfmt.Registry) error {
...
func (m *IpamsvcInheritedAsmEnableBlock) contextValidateDisplayName(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcInheritedAsmEnableBlock) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcInheritedAsmEnableBlock) UnmarshalBinary(b []byte) error {
	var res IpamsvcInheritedAsmEnableBlock
