...
func (m *ConfigCreateAuthZoneResponse) validateResult(formats strfmt.Registry) error {
...
func (m *ConfigCreateAuthZoneResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigCreateAuthZoneResponse) UnmarshalBinary(b []byte) error {
	var res ConfigCreateAuthZoneResponse
