...
func (m *IpamsvcListOptionFilterResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IpamsvcListOptionFilterResponse) validateResults(formats strfmt.Registry) error {
...
func (m *IpamsvcListOptionFilterResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcListOptionFilterResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcListOptionFilterResponse
