...
func (m *IpamsvcUpdateIpamHostResponse) validateResult(formats strfmt.Registry) error {
...
func (m *IpamsvcUpdateIpamHostResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcUpdateIpamHostResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcUpdateIpamHostResponse
