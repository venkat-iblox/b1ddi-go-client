...
func (m *IpamsvcReadSubnetResponse) validateResult(formats strfmt.Registry) error {
...
func (m *IpamsvcReadSubnetResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcReadSubnetResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcReadSubnetResponse
