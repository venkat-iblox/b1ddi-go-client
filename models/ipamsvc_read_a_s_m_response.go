...
func (m *IpamsvcReadASMResponse) validateResult(formats strfmt.Registry) error {
...
func (m *IpamsvcReadASMResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcReadASMResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcReadASMResponse
