...
func (m *IpamsvcNextAvailableABResponse) validateResults(formats strfmt.Registry) error {
...
func (m *IpamsvcNextAvailableABResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcNextAvailableABResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcNextAvailableABResponse
