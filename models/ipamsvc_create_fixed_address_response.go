...
func (m *IpamsvcCreateFixedAddressResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IpamsvcCreateFixedAddressResponse) validateResult(formats strfmt.Registry) error {
...
func (m *IpamsvcCreateFixedAddressResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcCreateFixedAddressResponse
