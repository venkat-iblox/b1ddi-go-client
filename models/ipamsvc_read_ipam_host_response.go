...
func (m *IpamsvcReadIpamHostResponse) validateResult(formats strfmt.Registry) error {
...
func (m *IpamsvcReadIpamHostResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcReadIpamHostResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcReadIpamHostResponse
