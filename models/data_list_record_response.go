...
func (m *DataListRecordResponse) validateResults(formats strfmt.Registry) error {
...
func (m *DataListRecordResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DataListRecordResponse) UnmarshalBinary(b []byte) error {
	var res DataListRecordResponse
