...
func (m *IpamsvcUpdateOptionCodeResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IpamsvcUpdateOptionCodeResponse) validateResult(formats strfmt.Registry) error {
...
func (m *IpamsvcUpdateOptionCodeResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcUpdateOptionCodeResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcUpdateOptionCodeResponse
