...
func (m *IpamsvcUpdateOptionSpaceResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IpamsvcUpdateOptionSpaceResponse) validateResult(formats strfmt.Registry) error {
...
func (m *IpamsvcUpdateOptionSpaceResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcUpdateOptionSpaceResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcUpdateOptionSpaceResponse
