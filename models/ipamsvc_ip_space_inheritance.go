...
func (m *IpamsvcIPSpaceInheritance) validateAsmConfig(formats strfmt.Registry) error {
...
func (m *IpamsvcIPSpaceInheritance) validateDdnsClientUpdate(formats strfmt.Registry) error {
...
func (m *IpamsvcIPSpaceInheritance) validateDdnsHostnameBlock(formats strfmt.Registry) error {
...
func (m *IpamsvcIPSpaceInheritance) validateDdnsUpdateBlock(formats strfmt.Registry) error {
...
func (m *IpamsvcIPSpaceInheritance) validateDdnsUpdateOnRenew(formats strfmt.Registry) error {
...
func (m *IpamsvcIPSpaceInheritance) validateDdnsUseConflictResolution(formats strfmt.Registry) error {
...
func (m *IpamsvcIPSpaceInheritance) validateDhcpConfig(formats strfmt.Registry) error {
...
func (m *IpamsvcIPSpaceInheritance) validateDhcpOptions(formats strfmt.Registry) error {
...
func (m *IpamsvcIPSpaceInheritance) validateHeaderOptionFilename(formats strfmt.Registry) error {
...
func (m *IpamsvcIPSpaceInheritance) validateHeaderOptionServerAddress(formats strfmt.Registry) error {
...
func (m *IpamsvcIPSpaceInheritance) validateHeaderOptionServerName(formats strfmt.Registry) error {
...
func (m *IpamsvcIPSpaceInheritance) validateHostnameRewriteBlock(formats strfmt.Registry) error {
...
func (m *IpamsvcIPSpaceInheritance) validateVendorSpecificOptionOptionSpace(formats strfmt.Registry) error {
...
func (m *IpamsvcIPSpaceInheritance) UnmarshalBinary(b []byte) error {
	var res IpamsvcIPSpaceInheritance
