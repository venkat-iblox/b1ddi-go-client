...
func (m *IpamsvcUpdateHostResponse) validateResult(formats strfmt.Registry) error {
...
func (m *IpamsvcUpdateHostResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcUpdateHostResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcUpdateHostResponse
