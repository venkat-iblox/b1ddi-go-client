...
func (m *ConfigReadAuthZoneResponse) validateResult(formats strfmt.Registry) error {
...
func (m *ConfigReadAuthZoneResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigReadAuthZoneResponse) UnmarshalBinary(b []byte) error {
	var res ConfigReadAuthZoneResponse
