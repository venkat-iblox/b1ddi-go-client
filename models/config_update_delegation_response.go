...
func (m *ConfigUpdateDelegationResponse) validateResult(formats strfmt.Registry) error {
...
func (m *ConfigUpdateDelegationResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigUpdateDelegationResponse) UnmarshalBinary(b []byte) error {
	var res ConfigUpdateDelegationResponse
