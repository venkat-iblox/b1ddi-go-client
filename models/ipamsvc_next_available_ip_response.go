...
func (m *IpamsvcNextAvailableIPResponse) validateResults(formats strfmt.Registry) error {
...
func (m *IpamsvcNextAvailableIPResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcNextAvailableIPResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcNextAvailableIPResponse
