...
func (m *ConfigReadGlobalResponse) validateResult(formats strfmt.Registry) error {
...
func (m *ConfigReadGlobalResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigReadGlobalResponse) UnmarshalBinary(b []byte) error {
	var res ConfigReadGlobalResponse
