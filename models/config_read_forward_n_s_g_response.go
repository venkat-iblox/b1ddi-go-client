...
func (m *ConfigReadForwardNSGResponse) validateResult(formats strfmt.Registry) error {
...
func (m *ConfigReadForwardNSGResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigReadForwardNSGResponse) UnmarshalBinary(b []byte) error {
	var res ConfigReadForwardNSGResponse
