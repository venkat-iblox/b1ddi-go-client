...
func (m *IpamsvcListDNSUsageResponse) validateResults(formats strfmt.Registry) error {
...
func (m *IpamsvcListDNSUsageResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IpamsvcListDNSUsageResponse) UnmarshalBinary(b []byte) error {
	var res IpamsvcListDNSUsageResponse
