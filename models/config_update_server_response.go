...
func (m *ConfigUpdateServerResponse) validateResult(formats strfmt.Registry) error {
...
func (m *ConfigUpdateServerResponse) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigUpdateServerResponse) UnmarshalBinary(b []byte) error {
	var res ConfigUpdateServerResponse
