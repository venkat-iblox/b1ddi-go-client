...
// NewDelegationListParams creates a new DelegationListParams object,
...
func NewDelegationListParams() *DelegationListParams {
	return &DelegationListParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewDelegationListParamsWithTimeout creates a new DelegationListParams object
...
// NewDelegationListParamsWithContext creates a new DelegationListParams object
...
// NewDelegationListParamsWithHTTPClient creates a new DelegationListParams object
...
func (o *DelegationListParams) WithContext(ctx context.Context) *DelegationListParams {
	o.SetContext(ctx)
	return o
}
