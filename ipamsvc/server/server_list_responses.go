...
type ServerListOK struct {
	Payload *models.IpamsvcListServerResponse
}

func (o *ServerListOK) Error() string {
	return fmt.Sprintf("[GET /dhcp/server][%d] serverListOK  %+v", 200, o.Payload)
}
func (o *ServerListOK) GetPayload() *models.IpamsvcListServerResponse {
	return o.Payload
}

func (o *ServerListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.IpamsvcListServerResponse)
