...
func (o *DhcpHostListAssociationsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	result := NewDhcpHostListAssociationsOK()
...
func NewDhcpHostListAssociationsOK() *DhcpHostListAssociationsOK {
	return &DhcpHostListAssociationsOK{}
}
...
func (o *DhcpHostListAssociationsOK) Error() string {
	return fmt.Sprintf("[GET /dhcp/host/{id}/associations][%d] dhcpHostListAssociationsOK  %+v", 200, o.Payload)
}
func (o *DhcpHostListAssociationsOK) GetPayload() *models.IpamsvcHostAssociationsResponse {
	return o.Payload
}

func (o *DhcpHostListAssociationsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.IpamsvcHostAssociationsResponse)
