...
type ClientService interface {
	AsmCreate(params *AsmCreateParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*AsmCreateOK, error)
...
*/
func (a *Client) AsmCreate(params *AsmCreateParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*AsmCreateOK, error) {
