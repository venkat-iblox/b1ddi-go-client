...
func (o *RangeListOK) Error() string {
	return fmt.Sprintf("[GET /ipam/range][%d] rangeListOK  %+v", 200, o.Payload)
}
func (o *RangeListOK) GetPayload() *models.IpamsvcListRangeResponse {
	return o.Payload
}

func (o *RangeListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.IpamsvcListRangeResponse)
