...
func (a *Client) FilterList(params *FilterListParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*FilterListOK, error) {
	...
	if params == nil {
		params = NewFilterListParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "filterList",
		Method:             "GET",
		PathPattern:        "/dhcp/filter",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http", "https"},
		Params:             params,
		Reader:             &FilterListReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*FilterListOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for filterList: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
