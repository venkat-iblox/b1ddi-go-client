...
func (o *FilterListOK) Error() string {
	return fmt.Sprintf("[GET /dhcp/filter][%d] filterListOK  %+v", 200, o.Payload)
}
func (o *FilterListOK) GetPayload() *models.IpamsvcListFilterResponse {
	return o.Payload
}

func (o *FilterListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.IpamsvcListFilterResponse)
