...
// NewAddressListParams creates a new AddressListParams object,
...
// NewAddressListParamsWithTimeout creates a new AddressListParams object
...
// NewAddressListParamsWithContext creates a new AddressListParams object
...
// NewAddressListParamsWithHTTPClient creates a new AddressListParams object
...
func (o *AddressListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.AddressState != nil {
		...
		if qAddressState != "" {
			...
			if err := r.SetQueryParam("address_state", qAddressState); err != nil {
				return err
			}
		}
	}
